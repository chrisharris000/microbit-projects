...
#TIMERS FOR CAR 0
off_time_0 = running_time() + car_delay
big_delay_0 = False
big_delay_time_0 = 0

#TIMERS FOR CAR 1
off_time_1 = running_time() + car_delay
big_delay_1 = False
big_delay_time_1 = 0

#TIMERS FOR CAR 2
off_time_2 = running_time() + car_delay
big_delay_2 = False
big_delay_time_2 = 0

#TIMERS FOR CAR 3
off_time_3 = running_time() + car_delay
big_delay_3 = False
big_delay_time_3 = 0

#TIMERS FOR CAR 4
off_time_4 = running_time() + car_delay
big_delay_4 = True
big_delay_time_4 = 0
